    ...
    >
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav className="flex space-x-4 md:space-x-6">
          ...
          <a href="#" onClick={() => scrollToDiv('waitlist-form')} className="text-gray-300 hover:text-primary transition-colors duration-300 text-sm sm:text-base">Lista de Espera</a>
        </nav>
      </div>
    </motion.header>
  );
