        ...
        <CardContent className="flex-grow">
          {price && (
            <div className="mb-6">
              ...
              {!isExpert && <p className="text-sm text-gray-400">Acesso imediato e gratuito. Sem cadastro</p>}
            </div>
          )}
    ...
    <section id="about-course" className="py-20 px-4 sm:px-8 bg-gray-950">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          <PlanCard
            title="Basic"
            description="Comece sua jornada na OpenAI com aulas completas e código fonte."
            price="R$ 0"
          ...
          <PlanCard
            title="Expert"
            description="A experiência completa para se tornar um especialista em OpenAI."
            price="R$ 199"
